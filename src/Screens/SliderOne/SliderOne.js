        ...
        >
          ...
          <View style={styles._body}>
            ...
            <Text style={styles._des}>
              The U.S. dollar can be printed
              {"\n"}at any time, flooding the
              {"\n"}market with new currency.
            </Text>
            <Text style={styles._des}>
              But we have the best option a token that holds its currency
              difficult to manipulate and you can trade with it.!
            </Text>
          </View>
        </ScrollView>
        <TouchableOpacity
