    ...
    <View style={styles.container}>
      ...
      <View style={styles._main}>
        ...
        >
          ...
          <Image
            source={require("./../../img/sliderimage22.jpg")}
            style={styles.sliderimage12}
          />
          ...
          <View style={styles._body}>
            ...
            >
              Use cryptobank now we bring the future to you.
            </Text>
            <Text
              style={{
                color: "#1F304C",
            ...
            >
              Cryptobank Brings the future tot you. And is the best place to
              earn buy and trade your crypto. On top of that you can consume
              your money with our crypto card!
            </Text>
          </View>
        </ScrollView>
        <TouchableOpacity
          style={styles._skip_btn}
      ...
      <View style={styles._step_main}>
        ...
        <TouchableOpacity
          style={styles._tick_btn}
          onPress={() => props.navigation.navigate("SliderOne")}
        >
